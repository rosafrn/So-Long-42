NAME    = so_long
INC     = ./include/minilibx-linux# could be /usr/include depending on your OS
INCFT   = ./include/libft# header from libft
LIBFT   = ./include/libft# path to libft library
LIBMLX  = ./include/minilibx-linux# could be /usr/lib, depends on where you decided to put your mlx library
